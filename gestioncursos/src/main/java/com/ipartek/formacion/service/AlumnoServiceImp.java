...
public class AlumnoServiceImp implements AlumnoService {
	...
	/*
	 * private void init() { Alumno alumno = null; try { alumno = new Alumno();
	 * alumno.setCodigo(1); alumno.setDni("68925141y");
	 * alumno.setNombre("Imanol"); alumno.setApellidos("Jimenez Lopez");
	 * alumnos.add(alumno); i++; } catch (CandidatoException e) { // TODO
	 * Auto-generated catch block System.out.println(e.getMessage()); }
	 * 
	 * try { alumno = new Alumno(); alumno.setCodigo(2);
	 * alumno.setNombre("Josu"); alumno.setDni("68925142z");
	 * alumno.setApellidos("Asua Gallego"); alumnos.add(alumno); i++; } catch
	 * (CandidatoException e) { // TODO Auto-generated catch block
	 * e.printStackTrace(); }
	 * 
	 * try { alumno = new Alumno(); alumno.setCodigo(3);
	 * alumno.setNombre("Alvaro"); alumno.setApellidos("Rodriguez Miguel");
	 * alumnos.add(alumno); i++; } catch (Exception e) { // TODO Auto-generated
