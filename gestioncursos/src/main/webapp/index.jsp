   			...
   			<div class="panel-body">
       			<form class="form-horizontal" action="<%=Constantes.SERVLET_LOGIN %>" method="post" role="form">
           			...
           			<c:set var="userName" value="${cookie.c_usuario.value}" />
						...
						<input id="<%=Constantes.PAR_USERNAME %>" name="<%=Constantes.PAR_USERNAME %>" type="text" class="form-control" value="${cookie.c_usuario.usuario }" placeholder="Introduzca su usuario">                                        
           			
           			</div>
		           <div class="input-group">
		           		<label class="sr-only" for="<%=Constantes.PAR_PASSWORD%>">Contraseña:</label>
						<span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
						<input name="<%=Constantes.PAR_PASSWORD%>" id="<%=Constantes.PAR_PASSWORD%>" value="${cookie.c_usuario.password }" type="password" class="form-control" placeholder="Introduzca su contraseña">
		            </div>
		           <div class="input-group">
						<div class="checkbox">			            	
                   ...
                   <div class="form-group">
						...
						<div class="col-xs-10">
							<select name="<%=Constantes.PAR_IDIOMA%>"  id="<%=Constantes.PAR_IDIOMA%>">
					  			<c:forEach var="idioma" items="<%=Idioma.values() %>" >
