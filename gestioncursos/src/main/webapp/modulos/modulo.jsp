<%@page import="com.ipartek.formacion.services.Horas"%>
		...
		%>
			...
			<form name="" id="" method='post' 
				...
				<div class="form-group">
					...
					<%
					Horas[] duraciones = (Horas[])request.getAttribute(Constantes.ATT_LISTA_DURACION_MODULO);
					if(duraciones!=null){
						for(Horas duracion: duraciones){
							%>
						<option <%= duracion.equals(modulo.getDuracion()) ? "selected" : "" %> 
